...
class Crane:
    ...
    def transfer_container(self, containers, target: Stack, source: Stack):
        for i in range(0, containers):
            target.add_container(source.remove_top_container())
...
class Inputhandler:
    ...
    def execute_instructions(self):
        for instruction in self.instructions:
            ...
            self.crane.transfer_container(int(instruction[0]), target, source)
